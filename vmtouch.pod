...
Create a PID file. This option is only working with -l or -L. The PID file will be automatically deleted when vmtouch got termination signals (SIGINT, SIGTERM, SIGQUIT) and leave.
